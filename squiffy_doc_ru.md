...
Создавайте на сцене действия, используя одиночные квадратные скобки, а затем двоеточие. Действия могут выводить текст, содержащий другие действия. После того, как игрок нажимает на ссылку действия, эта ссылка становится неактивной, игрок может кликнуть на неё только один раз. При переходе в другую сцену и, потом, возвращении на прежнюю сцену, все ранее деактивированные ссылки станут снова активными, если не указано иное, например проверка трекером. Для создания активной ссылки действия внутри сцены используйте одиночные квадратные скобки.
```
