...
Русский перевод выполнен машиной. Некоторые выражения и понятия адаптированы для лучшего понимания русскоязычными пользователями, изменен порядок заголовков. Этот перевод находится в состоянии доработки.
...
Чтобы создавать интерактивные истории, вам нужно использовать разметку и комманды движка Squiffy. Есть два типа текстовых блоков, которые вы можете использовать в Squiffy:
