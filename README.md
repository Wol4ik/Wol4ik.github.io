...
## Категории
* Специальные имена [Special Names] [aa]
...
[aa]: Этот раздел посвящён специальным названиям параграфов, тегов и переменных, которые имеют особое значения для SugarCube.
