...
(**Passages**) Действия - это меньшие единицы, которые существуют внутри секций(разделов, параграфов).

Взятие игрока в новый раздел приведет к **деактивации всех предыдущих ссылок**, поэтому используйте новую сцену, когда игрок предпринял некоторые действия, чтобы спродвинуть сюжет вперед.
...
# Замена и ее последовательность
