...
Вы можете установить атрибут в разделе или проходе следующим образом:
```
@set score = 1000
```
...
Пустое имя раздела или прохода создает «мастер», который запускается для каждого раздела или прохода в игре. (Мастер-проход, определенный в именованном разделе, будет запускаться только для каждого прохода в этом разделе)
